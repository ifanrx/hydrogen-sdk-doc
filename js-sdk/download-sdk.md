...
- [京东小程序 SDK v{{ book.latestVersionJingdong }}](https://dl.ifanr.cn/hydrogen/sdk/sdk-jingdong.{{book.latestVersionJingdong}}.zip)
- [快手小程序 SDK（公测） v{{ book.latestVersionKuaishou }}](https://dl.ifanr.cn/hydrogen/sdk/sdk-kuaishou.{{book.latestVersionKuaishou}}.zip)
