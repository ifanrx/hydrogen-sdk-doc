...
`GET https://cloud.minapp.com/userve/v2.0/miniapp/user-profile/`
...
axios.get('https://cloud.minapp.com/userve/v2.0/miniapp/user-profile/', {
  params: {
...
`GET https://cloud.minapp.com/userve/v2.0/miniapp/user-profile/?user_id={{user_id}}`
