...
* [JS SDK](js-sdk/README.md)
    ...
    * [字节跳动（头条、抖音等）小程序](js-sdk/bytedance/README.md)
        ...
        * [订阅消息](js-sdk/bytedance/subscribe-message.md)
...
* [云函数 Node.js SDK](cloud-function/node-sdk/README.md)
    ...
    * [订阅消息](cloud-function/node-sdk/subscribe-message/README.md)
        ...
        * [字节跳动（头条、抖音等）小程序](cloud-function/node-sdk/subscribe-message/bytedance/README.md)
            * [发送订阅消息](cloud-function/node-sdk/subscribe-message/bytedance/subscribe-message.md)
            * [获取可用订阅记录数量](cloud-function/node-sdk/subscribe-message/bytedance/subscribe-message-ticket.md)
