...
* [JS SDK](js-sdk/README.md)
    ...
    * [数据表 (SDK 1.1.0 以下版本)](js-sdk/legacySchema/README.md)
        * [新增数据项](js-sdk/legacySchema/create-record.md)
        * [更新数据项](js-sdk/legacySchema/update-record.md)
        * [删除数据项](js-sdk/legacySchema/delete-record.md)
        * [获取数据项列表](js-sdk/legacySchema/get-record-list.md)
        * [获取数据项详情](js-sdk/legacySchema/get-record-detail.md)
    * [网络请求](js-sdk/request/README.md)
    * [支付](js-sdk/payment/README.md)
        * [微信支付](js-sdk/payment/pay.md)
        * [订单查询](js-sdk/payment/order.md)
    * [本地存储](js-sdk/localStorage/README.md)
    ...
    * [模板消息](js-sdk/templateMessage/README.md)
    * [微信加密数据解密](js-sdk/wechatDecrypt/README.md)
    ...
    * [错误码详解](js-sdk/errorCode/README.md)
